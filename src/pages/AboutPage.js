        ...
        <div className="about-text">
          ...
          <Stack
            ...
            <Stack>
              ...
              <a className="logo-text" href="mailto:kayle.patton22@gmail.com" target="_blank" rel="noreferrer">GitHub</a>
            </Stack>
            <Stack>
              <IconButton
                aria-label="linkedin"
              ...
              <a className="logo-text" href="mailto:kayle.patton22@gmail.com" target="_blank" rel="noreferrer">LinkedIn</a>
            </Stack>
            <Stack>
              <IconButton
              ...
              <a className="logo-text" href="mailto:kayle.patton22@gmail.com" target="_blank" rel="noreferrer">Portfolio</a>
            </Stack>
            <Stack>
              <IconButton
                aria-label="email"
